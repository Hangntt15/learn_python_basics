...
class ObjectDetail(Data):
    class WaitingPDEContributions(Data):
        def get_pde_contributions_list(self):
            raw_contributions_list = self.data
            contributions_list = []
    ...
    class PDEPoolPairs(Data):
        def get_pde_pool_pairs_list(self):
            raw_pool_pairs_list = self.data
            pool_pair_list = []
    ...
    class PDEShares(Data):
        def get_pde_shares_list(self):
            raw_shares_list = self.data
            pde_shares_list = []
    ...
    class PDETradingFees(Data):
        def get_pde_trading_fees_list(self):
            raw_trading_fees_list = self.data
    ...
    def get_waiting_pde_contributions(self):
        return ObjectDetail.WaitingPDEContributions(self.data['WaitingPDEContributions'])

    def get_pde_pool_pairs(self):
        return ObjectDetail.PDEPoolPairs(self.data['PDEPoolPairs'])

    def get_pde_shares(self):
        return ObjectDetail.PDEShares(self.data['PDEShares'])

    def get_pde_trading_fees(self):
        return ObjectDetail.PDETradingFees(self.data['PDETradingFees'])
